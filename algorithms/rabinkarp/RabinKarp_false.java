...
public class RabinKarp_false {
     ...
     */
    public RabinKarp_false(char[] pattern, int R) {
     ...
     */
    public RabinKarp_false(String pat) {
	...
	if (args.length<2) return;
        ...
        RabinKarp_false searcher = new RabinKarp_false(pat);
